...
#include "ui_regresion_multiple.h"
#include"math.h"

Regresion_Multiple::Regresion_Multiple(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::Regresion_Multiple)
{
    ui->setupUi(this);
...
void Regresion_Multiple::procesar_RM(){
...
void Regresion_Multiple::borrar_RM() //cleaning process
{
        //cleans all
